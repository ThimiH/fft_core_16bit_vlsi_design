...
# Created by write_sdc on Tue Jul 22 16:02:07 2025
...
group_path -name input_paths  -from [get_ports reset]  -to [list [get_cells out_push_F_reg] [get_cells -hsc @                        \
...
group_path -name input_paths  -from [list [get_ports clk] [get_ports in_push] [get_ports {in_real[15]}]     \
[get_ports {in_real[14]}] [get_ports {in_real[13]}] [get_ports {in_real[12]}]  \
[get_ports {in_real[11]}] [get_ports {in_real[10]}] [get_ports {in_real[9]}]   \
[get_ports {in_real[8]}] [get_ports {in_real[7]}] [get_ports {in_real[6]}]     \
[get_ports {in_real[5]}] [get_ports {in_real[4]}] [get_ports {in_real[3]}]     \
[get_ports {in_real[2]}] [get_ports {in_real[1]}] [get_ports {in_real[0]}]     \
[get_ports {in_imag[15]}] [get_ports {in_imag[14]}] [get_ports {in_imag[13]}]  \
[get_ports {in_imag[12]}] [get_ports {in_imag[11]}] [get_ports {in_imag[10]}]  \
[get_ports {in_imag[9]}] [get_ports {in_imag[8]}] [get_ports {in_imag[7]}]     \
[get_ports {in_imag[6]}] [get_ports {in_imag[5]}] [get_ports {in_imag[4]}]     \
[get_ports {in_imag[3]}] [get_ports {in_imag[2]}] [get_ports {in_imag[1]}]     \
[get_ports {in_imag[0]}] [get_ports out_stall]]  -to [list [get_cells out_push_F_reg] [get_cells -hsc @                        \
{butterfly_0/Zrb_F_reg[0]}] [get_cells -hsc @ {butterfly_0/Zrb_F_reg[1]}]      \
[get_cells -hsc @ {butterfly_0/Zrb_F_reg[2]}] [get_cells -hsc @                \
{butterfly_0/Zrb_F_reg[3]}] [get_cells -hsc @ {butterfly_0/Zrb_F_reg[4]}]      \
[get_cells -hsc @ {butterfly_0/Zrb_F_reg[5]}] [get_cells -hsc @                \
...
{fft_ctrl_sm_0/A_addr_Fd3_reg[3]}] [get_cells -hsc @                           \
fft_ctrl_sm_0/skip_Fd4_reg]]
group_path -name output_paths  -from [list [get_cells out_push_F_reg] [get_cells -hsc @                      \
{butterfly_0/Zrb_F_reg[0]}] [get_cells -hsc @ {butterfly_0/Zrb_F_reg[1]}]      \
[get_cells -hsc @ {butterfly_0/Zrb_F_reg[2]}] [get_cells -hsc @                \
{butterfly_0/Zrb_F_reg[3]}] [get_cells -hsc @ {butterfly_0/Zrb_F_reg[4]}]      \
[get_cells -hsc @ {butterfly_0/Zrb_F_reg[5]}] [get_cells -hsc @                \
...
{fft_ctrl_sm_0/A_addr_Fd3_reg[2]}] [get_cells -hsc @                           \
{fft_ctrl_sm_0/A_addr_Fd3_reg[3]}] [get_cells -hsc @                           \
fft_ctrl_sm_0/skip_Fd4_reg]]  -to [list [get_ports in_stall] [get_ports out_push_F] [get_ports              \
{out_real_F[15]}] [get_ports {out_real_F[14]}] [get_ports {out_real_F[13]}]    \
[get_ports {out_real_F[12]}] [get_ports {out_real_F[11]}] [get_ports           \
{out_real_F[10]}] [get_ports {out_real_F[9]}] [get_ports {out_real_F[8]}]      \
[get_ports {out_real_F[7]}] [get_ports {out_real_F[6]}] [get_ports             \
{out_real_F[5]}] [get_ports {out_real_F[4]}] [get_ports {out_real_F[3]}]       \
[get_ports {out_real_F[2]}] [get_ports {out_real_F[1]}] [get_ports             \
{out_real_F[0]}] [get_ports {out_imag_F[15]}] [get_ports {out_imag_F[14]}]     \
[get_ports {out_imag_F[13]}] [get_ports {out_imag_F[12]}] [get_ports           \
{out_imag_F[11]}] [get_ports {out_imag_F[10]}] [get_ports {out_imag_F[9]}]     \
[get_ports {out_imag_F[8]}] [get_ports {out_imag_F[7]}] [get_ports             \
{out_imag_F[6]}] [get_ports {out_imag_F[5]}] [get_ports {out_imag_F[4]}]       \
[get_ports {out_imag_F[3]}] [get_ports {out_imag_F[2]}] [get_ports             \
{out_imag_F[1]}] [get_ports {out_imag_F[0]}]]
group_path -name reg_to_reg  -from [list [get_cells out_push_F_reg] [get_cells -hsc @                      \
{butterfly_0/Zrb_F_reg[0]}] [get_cells -hsc @ {butterfly_0/Zrb_F_reg[1]}]      \
[get_cells -hsc @ {butterfly_0/Zrb_F_reg[2]}] [get_cells -hsc @                \
{butterfly_0/Zrb_F_reg[3]}] [get_cells -hsc @ {butterfly_0/Zrb_F_reg[4]}]      \
[get_cells -hsc @ {butterfly_0/Zrb_F_reg[5]}] [get_cells -hsc @                \
...
{fft_ctrl_sm_0/A_addr_Fd3_reg[2]}] [get_cells -hsc @                           \
{fft_ctrl_sm_0/A_addr_Fd3_reg[3]}] [get_cells -hsc @                           \
fft_ctrl_sm_0/skip_Fd4_reg]]  -to [list [get_cells out_push_F_reg] [get_cells -hsc @                        \
{butterfly_0/Zrb_F_reg[0]}] [get_cells -hsc @ {butterfly_0/Zrb_F_reg[1]}]      \
[get_cells -hsc @ {butterfly_0/Zrb_F_reg[2]}] [get_cells -hsc @                \
{butterfly_0/Zrb_F_reg[3]}] [get_cells -hsc @ {butterfly_0/Zrb_F_reg[4]}]      \
[get_cells -hsc @ {butterfly_0/Zrb_F_reg[5]}] [get_cells -hsc @                \
